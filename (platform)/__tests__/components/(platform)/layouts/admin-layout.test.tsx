...
import { AdminLayout } from '@/components/(platform)/layouts/admin-layout';
...
jest.mock('@/components/(platform)/shared/navigation/sidebar-nav', () => ({
...
// Mock header
jest.mock('@/components/(platform)/shared/navigation/header', () => ({
