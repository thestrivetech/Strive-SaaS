# REID Dashboard Integration - Session Start Prompt
...
4. **Important Reminders:**
   ...
   - Dark theme: Preserve --reid-* CSS variables (#0f172a bg, #06b6d4 cyan)
   - Elite tier: AI features require Elite subscription
   - Growth tier limits: 50 insights, 10 alerts, 5 reports/month
...
6. **Session End Requirements (MANDATORY):**
   ...
   - Creating session summary file at: C:\Users\zochr\Desktop\GitHub\Strive-SaaS\(platform)\update-sessions\dashboard-&-module-integrations\REIDashboard\session-{SESSION_NUMBER}-summary.md
   - Including:
...
- [ ] Elite tier AI restrictions verified
- [ ] Growth tier limits enforced (50/10/5)
...
5. **Don't break dark theme** - Always use --reid-* CSS variables, test in dark mode
