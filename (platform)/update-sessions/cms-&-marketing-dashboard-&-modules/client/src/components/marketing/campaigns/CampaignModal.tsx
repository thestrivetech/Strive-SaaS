...
export default function CampaignModal({ open, onOpenChange, onSubmit, campaignType, mode = "create" }: CampaignModalProps) {
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="active">Send Now</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
