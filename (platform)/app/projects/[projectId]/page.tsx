...
import { EditProjectDialog } from '@/components/(platform)/projects/edit-project-dialog';
import { DeleteProjectDialog } from '@/components/(platform)/projects/delete-project-dialog';
