...
import { getDealById, getStageTitle, getStageColor } from '@/lib/modules/deals';
import { DealFormDialog } from '@/components/(platform)/crm/deals/deal-form-dialog';
import { DealActionsMenu } from '@/components/(platform)/crm/deals/deal-actions-menu';
