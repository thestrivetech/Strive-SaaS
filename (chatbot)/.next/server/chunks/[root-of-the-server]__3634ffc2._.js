...
const ContactInfoSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    firstName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().describe('First name only'),
    lastName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().describe('Last name only'),
    fullName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().describe('Full name if provided together'),
...
function splitName(contactInfo) {
...
async function syncLeadToCRM(params) {
    ...
    try {
        ...
        const { firstName, lastName, fullName } = contactInfo ? (0, __TURBOPACK__imported__module__$5b$project$5d2f28$chatbot$292f$lib$2f$ai$2f$data$2d$extraction$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["splitName"])(contactInfo) : {
            firstName: undefined,
            lastName: undefined,
...
async function POST(req) {
    try {
        ...
        const enhancedSystemPrompt = buildEnhancedSystemPrompt(config.systemPrompt, sessionPreferences, extraction.extractedFields, canSearchNow);
...
/**
 * Build enhanced system prompt with conversation state
 */ function buildEnhancedSystemPrompt(basePrompt, sessionPreferences, extractedFields, canSearch) {
    let enhancement = '\n\n## 🎯 CONVERSATION STATE\n\n';
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3634ffc2._.js.map