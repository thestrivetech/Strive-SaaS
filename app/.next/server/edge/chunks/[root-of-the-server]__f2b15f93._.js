...
async function middleware(request) {
    ...
    const { createServerClient } = await Promise.resolve().then(()=>__turbopack_context__.i("[project]/node_modules/@supabase/ssr/dist/module/index.js [middleware-edge] (ecmascript)"));
    const supabase = createServerClient(("TURBOPACK compile-time value", "https://ffjdclxefgacpvcmyrii.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZmamRjbHhlZmdhY3B2Y215cmlpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTkwOTQwMDgsImV4cCI6MjA3NDY3MDAwOH0.Fbl353HZxRPH-txLSs2BiluQyy5jSMZbbE__A5LHziA"), {
        cookies: {
            get (name) {
    ...
    const isProtectedRoute = path.startsWith('/dashboard') || path.startsWith('/crm') || path.startsWith('/projects') || path.startsWith('/ai') || path.startsWith('/tools') || path.startsWith('/settings');
