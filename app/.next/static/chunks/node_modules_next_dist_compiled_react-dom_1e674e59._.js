...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        (JSCompiler_object_inline_digest_2528 = didSuspend) || (JSCompiler_object_inline_digest_2528 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_digest_2528 && (JSCompiler_object_inline_message_2527 = !0, workInProgress.flags &= -129);
        JSCompiler_object_inline_digest_2528 = 0 !== (workInProgress.flags & 32);
        workInProgress.flags &= -33;
        if (null === current) {
            if (isHydrating) {
                JSCompiler_object_inline_message_2527 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
                (current = nextHydratableInstance) ? (renderLanes = canHydrateHydrationBoundary(current, rootOrSingletonContext), renderLanes = null !== renderLanes && renderLanes.data !== ACTIVITY_START_DATA ? renderLanes : null, null !== renderLanes && (JSCompiler_object_inline_digest_2528 = {
                    dehydrated: renderLanes,
                    treeContext: getSuspendedTreeContext(),
                    retryLane: 536870912,
                    hydrationErrors: null
                }, workInProgress.memoizedState = JSCompiler_object_inline_digest_2528, JSCompiler_object_inline_digest_2528 = createFiberFromDehydratedFragment(renderLanes), JSCompiler_object_inline_digest_2528.return = workInProgress, workInProgress.child = JSCompiler_object_inline_digest_2528, hydrationParentFiber = workInProgress, nextHydratableInstance = null)) : renderLanes = null;
                if (null === renderLanes) throw warnNonHydratedInstance(workInProgress, current), throwOnHydrationMismatch(workInProgress);
            ...
            JSCompiler_object_inline_stack_2529 = JSCompiler_object_inline_stack_2529.fallback;
            if (JSCompiler_object_inline_message_2527) {
                ...
                JSCompiler_object_inline_stack_2529 = createFiberFromFragment(JSCompiler_object_inline_stack_2529, mode, renderLanes, null);
                ...
                JSCompiler_object_inline_stack_2529.memoizedState = mountSuspenseOffscreenState(renderLanes);
                JSCompiler_object_inline_stack_2529.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2528, renderLanes);
                workInProgress.memoizedState = SUSPENDED_MARKER;
                return bailoutOffscreenComponent(null, JSCompiler_object_inline_stack_2529);
            }
        ...
        if (null !== prevState) {
            ...
            if (null !== JSCompiler_object_inline_componentStack_2530) {
                if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), nextPrimaryChildren = JSCompiler_object_inline_stack_2529.fallback, mode = workInProgress.mode, JSCompiler_object_inline_stack_2529 = mountWorkInProgressOffscreenFiber({
                    mode: "visible",
                    children: JSCompiler_object_inline_stack_2529.children
                }, mode), nextPrimaryChildren = createFiberFromFragment(nextPrimaryChildren, mode, renderLanes, null), nextPrimaryChildren.flags |= 2, JSCompiler_object_inline_stack_2529.return = workInProgress, nextPrimaryChildren.return = workInProgress, JSCompiler_object_inline_stack_2529.sibling = nextPrimaryChildren, workInProgress.child = JSCompiler_object_inline_stack_2529, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2529 = workInProgress.child, JSCompiler_object_inline_stack_2529.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2529.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2528, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = bailoutOffscreenComponent(null, JSCompiler_object_inline_stack_2529));
                else if (pushPrimaryTreeSuspenseHandler(workInProgress), warnIfHydrating(), isSuspenseInstanceFallback(JSCompiler_object_inline_componentStack_2530)) {
                    JSCompiler_object_inline_digest_2528 = JSCompiler_object_inline_componentStack_2530.nextSibling && JSCompiler_object_inline_componentStack_2530.nextSibling.dataset;
                    ...
                    nextPrimaryChildren.stack = JSCompiler_object_inline_stack_2529 || "";
                    nextPrimaryChildren.digest = JSCompiler_object_inline_digest_2528;
                    JSCompiler_object_inline_digest_2528 = void 0 === mode ? null : mode;
                    JSCompiler_object_inline_stack_2529 = {
                        value: nextPrimaryChildren,
                        source: null,
                        stack: JSCompiler_object_inline_digest_2528
                    };
                    "string" === typeof JSCompiler_object_inline_digest_2528 && CapturedStacks.set(nextPrimaryChildren, JSCompiler_object_inline_stack_2529);
                    queueHydrationError(JSCompiler_object_inline_stack_2529);
                    workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
                } else if (didReceiveUpdate || propagateParentContextChanges(current, workInProgress, renderLanes, !1), JSCompiler_object_inline_digest_2528 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_digest_2528) {
                    JSCompiler_object_inline_digest_2528 = workInProgressRoot;
                    if (null !== JSCompiler_object_inline_digest_2528 && (JSCompiler_object_inline_stack_2529 = getBumpedLaneForHydration(JSCompiler_object_inline_digest_2528, renderLanes), 0 !== JSCompiler_object_inline_stack_2529 && JSCompiler_object_inline_stack_2529 !== prevState.retryLane)) throw prevState.retryLane = JSCompiler_object_inline_stack_2529, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2529), scheduleUpdateOnFiber(JSCompiler_object_inline_digest_2528, current, JSCompiler_object_inline_stack_2529), SelectiveHydrationException;
                    isSuspenseInstancePending(JSCompiler_object_inline_componentStack_2530) || renderDidSuspendDelayIfPossible();
                    workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
                } else isSuspenseInstancePending(JSCompiler_object_inline_componentStack_2530) ? (workInProgress.flags |= 192, workInProgress.child = current.child, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_componentStack_2530.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && restoreSuspendedTreeContext(workInProgress, current), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2529.children), workInProgress.flags |= 4096);
                return workInProgress;
            }
        }
        if (JSCompiler_object_inline_message_2527) return reuseSuspenseHandlerOnStack(workInProgress), nextPrimaryChildren = JSCompiler_object_inline_stack_2529.fallback, mode = workInProgress.mode, componentStack = current.child, JSCompiler_object_inline_componentStack_2530 = componentStack.sibling, JSCompiler_object_inline_stack_2529 = createWorkInProgress(componentStack, {
            mode: "hidden",
            children: JSCompiler_object_inline_stack_2529.children
        }), JSCompiler_object_inline_stack_2529.subtreeFlags = componentStack.subtreeFlags & 65011712, null !== JSCompiler_object_inline_componentStack_2530 ? nextPrimaryChildren = createWorkInProgress(JSCompiler_object_inline_componentStack_2530, nextPrimaryChildren) : (nextPrimaryChildren = createFiberFromFragment(nextPrimaryChildren, mode, renderLanes, null), nextPrimaryChildren.flags |= 2), nextPrimaryChildren.return = workInProgress, JSCompiler_object_inline_stack_2529.return = workInProgress, JSCompiler_object_inline_stack_2529.sibling = nextPrimaryChildren, workInProgress.child = JSCompiler_object_inline_stack_2529, bailoutOffscreenComponent(null, JSCompiler_object_inline_stack_2529), JSCompiler_object_inline_stack_2529 = workInProgress.child, nextPrimaryChildren = current.child.memoizedState, null === nextPrimaryChildren ? nextPrimaryChildren = mountSuspenseOffscreenState(renderLanes) : (mode = nextPrimaryChildren.cachePool, null !== mode ? (componentStack = CacheContext._currentValue, mode = mode.parent !== componentStack ? {
            parent: componentStack,
            pool: componentStack
        } : mode) : mode = getSuspendedCache(), nextPrimaryChildren = {
            baseLanes: nextPrimaryChildren.baseLanes | renderLanes,
            cachePool: mode
        }), JSCompiler_object_inline_stack_2529.memoizedState = nextPrimaryChildren, JSCompiler_object_inline_stack_2529.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2528, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, bailoutOffscreenComponent(current.child, JSCompiler_object_inline_stack_2529);
        pushPrimaryTreeSuspenseHandler(workInProgress);
        ...
        null !== current && (JSCompiler_object_inline_digest_2528 = workInProgress.deletions, null === JSCompiler_object_inline_digest_2528 ? (workInProgress.deletions = [
            current
        ], workInProgress.flags |= 16) : JSCompiler_object_inline_digest_2528.push(current));
    ...
    function performWorkOnRoot(root, lanes, forceSync) {
        ...
        var shouldTimeSlice = !forceSync && 0 === (lanes & 127) && 0 === (lanes & root.expiredLanes) || checkIfRootIsPrerendering(root, lanes), exitStatus = shouldTimeSlice ? renderRootConcurrent(root, lanes) : renderRootSync(root, lanes, !0), renderWasConcurrent = shouldTimeSlice;
        do {
                ...
                a: {
                    ...
                    if (null !== ReactSharedInternals.actQueue) commitRoot(shouldTimeSlice, forceSync, lanes, workInProgressRootRecoverableErrors, workInProgressTransitions, workInProgressRootDidIncludeRecursiveRenderUpdate, workInProgressDeferredLane, workInProgressRootInterleavedUpdatedLanes, workInProgressSuspendedRetryLanes);
                        ...
                        if ((lanes & 62914560) === lanes && (renderWasConcurrent = globalMostRecentFallbackTime + FALLBACK_THROTTLE_MS - now$1(), 10 < renderWasConcurrent)) {
                            ...
                            shouldTimeSlice.timeoutHandle = scheduleTimeout(commitRootWhenReady.bind(null, shouldTimeSlice, forceSync, workInProgressRootRecoverableErrors, workInProgressTransitions, workInProgressRootDidIncludeRecursiveRenderUpdate, lanes, workInProgressDeferredLane, workInProgressRootInterleavedUpdatedLanes, workInProgressSuspendedRetryLanes, workInProgressRootDidSkipSuspendedSiblings, exitStatus, "Throttled", renderStartTime, 0), renderWasConcurrent);
                            break a;
                        }
                        commitRootWhenReady(shouldTimeSlice, forceSync, workInProgressRootRecoverableErrors, workInProgressTransitions, workInProgressRootDidIncludeRecursiveRenderUpdate, lanes, workInProgressDeferredLane, workInProgressRootInterleavedUpdatedLanes, workInProgressSuspendedRetryLanes, workInProgressRootDidSkipSuspendedSiblings, exitStatus, null, renderStartTime, 0);
                    }
                }
            }
            break;
    ...
    function commitRootWhenReady(root, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        ...
        if (suspendedCommitReason & 8192 || 16785408 === (suspendedCommitReason & 16785408)) {
            ...
            if (null !== timeoutOffset) {
                pendingEffectsLanes = lanes;
                root.cancelPendingCommit = timeoutOffset(commitRoot.bind(null, root, finishedWork, lanes, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane, updatedLanes, suspendedRetryLanes, exitStatus, suspendedCommitReason, suspendedCommitReason.waitingForViewTransition ? "Waiting for the previous Animation" : 0 < suspendedCommitReason.count ? 0 < suspendedCommitReason.imgCount ? "Suspended on CSS and Images" : "Suspended on CSS" : 1 === suspendedCommitReason.imgCount ? "Suspended on an Image" : 0 < suspendedCommitReason.imgCount ? "Suspended on Images" : null, completedRenderStartTime, completedRenderEndTime));
    ...
    function flushSpawnedWork() {
        if (pendingEffectsStatus === PENDING_SPAWNED_WORK || pendingEffectsStatus === PENDING_AFTER_MUTATION_PHASE) {
            ...
            0 !== (lanes & 261930) && 0 !== (remainingLanes & 42) ? (nestedUpdateScheduled = !0, root === rootWithNestedUpdates ? nestedUpdateCount++ : (nestedUpdateCount = 0, rootWithNestedUpdates = root)) : nestedUpdateCount = 0;
    ...
    (function() {
        ...
        if ("19.2.0-canary-df38ac9a-20250926" !== isomorphicReactPackageVersion) throw Error('Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' + (isomorphicReactPackageVersion + "\n  - react-dom:  19.2.0-canary-df38ac9a-20250926\nLearn more: https://react.dev/warnings/version-mismatch"));
    })();
