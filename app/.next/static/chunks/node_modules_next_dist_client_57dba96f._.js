...
const version = "15.6.0-canary.33";
window.next = {
    version,
    appDir: true
};
...
function createDebugChannel(responseHeaders) {
    ...
    if (responseHeaders) {
        ...
        requestId = (_responseHeaders_get = responseHeaders.get(_approuterheaders.NEXT_REQUEST_ID_HEADER)) != null ? _responseHeaders_get : undefined;
        if (!requestId) {
...
function createPendingCacheNode(navigatedAt, routerState, prefetchData, prefetchHead, isPrefetchHeadPartial, segmentPath, scrollableSegmentsResult) {
    ...
    return {
        ...
        loading: prefetchData !== null ? (_prefetchData_ = prefetchData[3]) != null ? _prefetchData_ : null : createDeferredRsc(),
        navigatedAt
    };
}
...
function ServerRoot(param) {
    let { pendingActionQueue, webSocket, staticIndicatorState } = param;
